...
} from '@/constants/findReplaceMenu.const';
...
export const FindReplace: FC<FindReplaceProps> = (props) => {
  const {
    ...
    focusField = FIND_REPLACE_FOCUS_FIND,
  } = props;
  ...
  return (
    ...
    >
      ...
      <Field
        ...
        value={find}
        onChange={setFind}
        autoFocus={focusField === FIND_REPLACE_FOCUS_FIND}
      />
      <Field
        className={FIND_REPLACE_FIELD_CLASS}
        label={replaceLabel}
        value={replace}
        onChange={setReplace}
        autoFocus={focusField === FIND_REPLACE_FOCUS_REPLACE}
      />
